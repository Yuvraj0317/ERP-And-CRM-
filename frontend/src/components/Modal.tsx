...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, subtitle, children }) => {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog Panel */}
      <div
        className="relative bg-white dark:bg-slate-900 rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200/90 dark:border-slate-800 z-10 my-auto transform transition-all space-y-5 animate-modal-scale"
        role="dialog"
        aria-modal="true"
