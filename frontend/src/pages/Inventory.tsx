        ...
        <div className="flex-1 flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-sky-500"
            >
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="bg-slate-100 hover:bg-slate-200 text-slate-700 p-2 rounded-xl border"
                >
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-mono font-bold text-center text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-500"
                />
                <button
                  type="button"
                  onClick={() => setAdjustQty((prev) => prev + 5)}
